  ...
  return (
    <div>
      ...
      <div className="bg-gray-900 rounded-lg border border-gray-800">
        ...
        {reportError && (
          <div className="mx-5 mt-4 p-3 bg-red-900/30 border border-red-800 rounded-lg text-sm text-red-300 flex items-start gap-2">
            <span className="text-red-400 mt-0.5">⚠</span>
            <div>
              <div className="font-medium text-red-300 mb-0.5">Report generation failed</div>
              <div className="text-red-400 text-xs font-mono">{reportError}</div>
            </div>
            <button onClick={() => setReportError(null)} className="ml-auto text-red-500 hover:text-red-300 text-lg leading-none">×</button>
          </div>
        )}
        <div className="divide-y divide-gray-800">
          {grossResults.map(r => {
